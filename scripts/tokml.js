...
function markerStyle(_, styleHash) {
    return tag('Style',
        tag('LabelStyle',
            //tag('color','ff00ffff') +
            tag('color',SMConfig.getKmlMarkerLabelColor()) +
            tag('colorMode',SMConfig.getKmlMarkerLabelColorModel())
          ) + 
        tag('IconStyle',
            tag('Icon',
                tag('href', iconUrl(_)))) +
...
function markerStyle2(_, styleHash) {
    return tag('Style',
        tag('IconStyle',
            tag('Icon',
                tag('href', iconUrl(_)))) +
...
function iconUrl(_) {
    ...
    if (_['marker-symbol']=='MarkerStyleText'){
        return SMConfig.getKmlMarkerIconHref();
        //return 'http://files.2bulu.com/f/d1?downParams=s2An6%2B3%2BIWUr0OBxohfNOA%3D%3D%0A';    
    }    
